...
python lie_detector/c_freeform_analyse_probe_answers.py lie_detector/config/c_probe_discrimination/q1e3_fw.yaml
...
python lie_detector/f_trend_analysis.py lie_detector/config/e_activation_analysis/q1e3_fw.yaml
