# python lie_detector/a_initial_answers/deterministic.py lie_detector/z_config/a_initial_answers/dang_dm_balanced.yaml
# python lie_detector/a_initial_answers/stochastic.py lie_detector/z_config/a_initial_answers/dang_dm_balanced.yaml
...
python lie_detector/f_information_theoretic/j_design_probe_questions.py lie_detector/z_config/f_information_theoretic/dang_dm_balanced.yaml
python lie_detector/f_information_theoretic/k_designed_probe_answers.py lie_detector/z_config/f_information_theoretic/dang_dm_balanced.yaml
python lie_detector/f_information_theoretic/k2_designed_probe_analysis.py lie_detector/z_config/f_information_theoretic/dang_dm_balanced.yaml

python lie_detector/g_cutting_probes/a_projections.py lie_detector/z_config/f_information_theoretic/dang_dm_balanced.yaml
python lie_detector/g_cutting_probes/b_cut_probe_questions.py lie_detector/z_config/f_information_theoretic/dang_dm_balanced.yaml
python lie_detector/g_cutting_probes/c_correlate_over_time.py lie_detector/z_config/f_information_theoretic/dang_dm_balanced.yaml


python lie_detector/h_completion_probes/a_generating_probe_questions.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml
python lie_detector/h_completion_probes/bx_question_linear_probes.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml
python lie_detector/h_completion_probes/b_discriminative_probe_questions.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml
python lie_detector/h_completion_probes/b2_discriminative_interrogation.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml
python lie_detector/h_completion_probes/b3_contextual_interrogation.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml
python lie_detector/h_completion_probes/b4_probe_contextual_interrogation.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml

python lie_detector/h_completion_probes/c_generating_probe_questions.py lie_detector/z_config/h_generating_probes/dang_dm_balanced.yaml
