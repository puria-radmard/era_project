...
def create_probe_boxplot_modified(data: pd.DataFrame) -> plt.Axes:
    ...
    palette = {
        'Truth = 0 | Append = 0.0': '#d62728',    # red
        'Truth = 0 | Append = 1.0': '#ff7f7f',    # light red  
        'Truth = 1 | Append = 0.0': '#1f77b4',    # blue
        'Truth = 1 | Append = 1.0': '#87ceeb'     # light blue
    }
...
if __name__ == "__main__":
    ...
    # Load data
    probe_responses_path = os.path.join(output_path, 'b_original_probe_questions.csv')
