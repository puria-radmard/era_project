...
for chosen_trait, (ocean_key, ocean_direction) in chosen_trait_to_ocean_and_direction.items():
    ...
    try:
        ...
        random_all_data = np.zeros([repeats_per_context_length, num_context_lengths, len(relevant_questions_and_answers), 5])
        ...
        for cl_idx, context_length in enumerate(context_lengths):
            ...
            for rep_idx in range(repeats_per_context_length):
                ...
                for batch_idx in tqdm(range(num_minibatches)):
                    ...
                    control_in_context_answers = [f"Answer: {icqa['answer']}" for icqa in control_in_aq_batch]
                    ...
                    random_all_data[rep_idx, cl_idx, asked_questions_idx, :] = random_choice_probs.cpu().numpy()
            ...
            random_positive_question_relevant_data = random_all_data[:,:cl_idx + 1,positive_index_questions]      # [repeats_per_context_length, num_context_lengths done, num all positive questions, 5]
            ...
            random_negative_question_relevant_data = random_all_data[:,:cl_idx + 1,negative_index_questions]      # [repeats_per_context_length, num_context_lengths done, num all negative questions, 5]
